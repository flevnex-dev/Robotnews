            ...
            <script type="text/javascript">
                jQuery(document).ready(function () {
                    ...
                    var dataSource = new kendo.data.DataSource({
                        ...
                        schema: {
                            ...
                            model: {
                                id: "id",
                                fields: {
                                    id: {nullable: true},site_logo: {type: "string"},site_name: {type: "string"},facebook_fanpage_link: {type: "string"},twitter_fanpage_link: {type: "string"},google_plus_fanpage_link: {type: "string"},pinup: {type: "string"},
									date: {type: "string"}
                                }
                            }
                        }
                    ...
                    jQuery("#site_basic_info_25").kendoGrid({
                        ...
                        sortable: true,
                        groupable: true,
                        columns: [{field: "site_logo", title: "Site Logo"},{field: "site_name", title: "Site Name"},{field: "facebook_fanpage_link", title: "Facebook Fanpage Link"},{field: "twitter_fanpage_link", title: "Twitter Fanpage Link"},{field: "google_plus_fanpage_link", title: "Google Plus Fanpage Link"},{field: "pinup", title: "Pinup"},
