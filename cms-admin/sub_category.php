...
if (isset($_POST['create'])) {
    extract($_POST);
    if (!empty($category) && !empty($name) && !empty($link) && !empty($priority)) {
        $insert = array('category' => $category, 'name' => $name, 'link' => $link, 'priority' => $priority, 'date' => date('Y-m-d'), 'status' => 1);
    ...
    if (!empty($category) && !empty($name) && !empty($link) && !empty($priority)) {
        ...
        $upd2 = array('category' => $category, 'name' => $name, 'link' => $link, 'priority' => $priority, 'date' => date('Y-m-d'), 'status' => 1);
                    ...
                    if (isset($_GET['edit'])) {
                        ...
                        <div class="widget-body"><form  class="form-horizontal" method="post" action="" role="form">
                                <input type="hidden" name="id" value="<?php echo $_GET['edit']; ?>"><div class='form-group'>
                                    ...
                                    <div class='col-sm-9'>
                                        <input type='text' id='form-field-1' name='category' value='<?php echo $obj->SelectAllByVal($table, "id", $_GET['edit'], "category"); ?>' placeholder='Category' class='form-control' />
                                    </div>
...
<?php } else { ?>
                        ...
                        <div class="widget-body"><form  class="form-horizontal" method="post" action="" role="form"><div class='form-group'>
                                    ...
                                    <div class='col-sm-9'>
                                        <!--<input type='text' id='form-field-1' name='category' placeholder='Category' class='form-control' />-->
