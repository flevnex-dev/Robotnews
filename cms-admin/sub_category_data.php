    ...
    <body class="">
        ...
        <div id="content">
          ...
          <div class="innerAll spacing-x2">
                <div class="col-sm-12" id="sub_category_36"></div>
            </div>
        </div>
        <!-- // Sub Category END -->
                    ...
                    var dataSource = new kendo.data.DataSource({
                        ...
                        schema: {
                            ...
                            model: {
                                id: "id",
                                fields: {
                                    id: {nullable: true},category: {type: "string"},name: {type: "string"},link: {type: "string"},priority: {type: "string"},
									date: {type: "string"}
                                }
                            }
                        }
                    });
                    jQuery("#sub_category_36").kendoGrid({
                        ...
                        sortable: true,
                        groupable: true,
                        columns: [{field: "category", title: "Category"},{field: "name", title: "Name"},{field: "link", title: "Link"},{field: "priority", title: "Priority"},
